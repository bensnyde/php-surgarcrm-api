...
/**
 * SugarCRM SOAP API PHP Library
 *
 * Library class for easy interfacing with your SugarCRM instance
 * allowing for simple integration of SugarCRM functionality into your own applications.
 *
 * @category   Libraries
 * @package    SugarCRM
...
class SugarCRM {
        ...
        {
                $this->clientHandle->logout();
        }

        private function init($host, $user, $pass, $version = '6.5.0')
        {
                $options = array(
                        "location" => 'http://'.$host.'/service/v2/soap.php',
                        "uri" => 'http://'.$host.'/',
                        "trace" => 1
                );
